    ...
    <div class="w_auto">
        <div class="leve_left">
            <div class="cont_list2">
            	<ul>
                    ...
                    <li><a class="hover2" title="针织横机电脑控制系统" href="<?php echo U('Index/product');?>"<i>针织横机电脑控制系统</i><span></span></a></li>
                </ul>
            </div>
        </div>
        <div class="leve_right">
        	<div class="leve_cont">
            	<div class="pro_head">
                	<p>Products</p>
                    <span>针织横机电脑控制系统</span>
                    <div class="nav_page">
                        <a href="<?php echo U('Index/index');?>">首页</a>
                             &raquo;
                            <a href="<?php echo U('Index/product');?>">产品中心</a>
                    </div>
                </div>
                ...
                <div class="pro_list">
                	<ul>
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        	<a href="<?php echo U('Index/productshow',array('id'=>$vo['id']));?>">
                            	<div class="pro_list_img">
                                	<img src="./statics/home/images/product.jpg" width="130" height="90"/>
                                </div>
                                <div class="pro_list_text">
                                	<p><?php echo ($vo["title"]); ?></p>
                                    <i><?php echo ($vo["title"]); ?></i>
                                </div>
                                <a href="<?php echo U('Index/productshow',array('id'=>$vo['id']));?>" class="more">更多 ></a>
                            </a>
