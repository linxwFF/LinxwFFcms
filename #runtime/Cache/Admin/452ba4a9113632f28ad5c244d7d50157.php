...
<big>
    ...
    <div id="page-content">
        <div class="row fg-toolbar ui-toolbar ">
            <a href="<?php echo U('Adverts/addList');?>"  class="btn medium bg-gray ">
        ...
        <div class="row">
            <table class="table">
                ...
                <td>  <a title=""  href="<?php echo U('Adverts/advert_edit',array('advert_id'=>$item['advert_id']));?>" data-placement="top" class="btn medium ui-state-default" data-original-title="Edit">
    ...
    <script type="text/javascript">
        ...
        var ids  = [id];
        var delete_menu_url = "<?php echo U('Adverts/advert_delete');?>";
        if (confirm("确定要删除!")){
