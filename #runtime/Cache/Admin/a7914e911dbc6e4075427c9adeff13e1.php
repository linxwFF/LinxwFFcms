...
<big>
    ...
    <div class="tabs ui-tabs ui-widget ui-widget-content ui-corner-all">
       ...
       <form class="edit_form" class="col-md-12 form-label-right center-margin" method="post" action="<?php echo U('Channel/edit');?>">
        ...
        <div id="normal-tabs-1" aria-labelledby="ui-id-4" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" aria-expanded="true" aria-hidden="false" style="display: block;">
                                ...
                                <div class="form-row">
                                   ...
                                   <div class="form-checkbox-radio col-md-10">
                                    <div class="radio"><span class="ui-state-default btn radius-all-100 <?php if($info['ishidden'] == 0): ?>checked<?php endif; ?> "><input value='0' class="custom-radio" <?php if($info['ishidden'] == 0): ?>checked="checked"<?php endif; ?>   name="ishidden" id="" type="radio"><i class="glyph-icon icon-circle"></i></span></div>
                                    <label for="">显示</label>

                                    <div class="radio"><span class=" ui-state-default btn radius-all-100 <?php if($info['ishidden'] == 1): ?>checked<?php endif; ?>"><input value="1" class="custom-radio" <?php if($info['ishidden'] == 1): ?>checked="checked"<?php endif; ?> name="ishidden" id=""  type="radio"><i class="glyph-icon icon-circle"></i></span></div>
                                    <label for="">隐藏</label>
                                </div>
                              ...
                              <div class="form-row">
                                    <div class="form-label col-md-1">
                                       ...
                                       <div class="form-input col-md-4">
                                            <select name="module_id">
                                                <?php if(is_array($module)): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option <?php if($item['id'] == $info['mode_id']): ?>selected<?php endif; ?>  value="<?php echo ($item["id"]); ?>"><?php echo ($item["typename"]); ?> | <?php echo ($item["nid"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                </div>
                                <div class="form-row">
                                    ...
                                    <div class="form-input col-md-4">
                                        <input type="text" value="<?php echo ($info["name"]); ?>"  class="parsley-validated" data-required="true"   name="name" >
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-label col-md-1">
                                    ...
                                    <div class="form-input col-md-4">
                                        <input type="text" value="<?php echo ($info["sort"]); ?>"  name="sort"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-checkbox-radio col-md-10">
                                        <div class="radio"><span class="ui-state-default btn radius-all-100 <?php if($info['ispart'] == 0): ?>checked<?php endif; ?> "><input value='0' class="custom-radio" <?php if($info['ispart'] == 0): ?>checked="checked"<?php endif; ?> name="ispart" id="" type="radio"><i class="glyph-icon icon-circle"></i></span></div>
                                        <label for="">最终列表栏目</label>
                                        <div class="radio"><span class=" ui-state-default btn radius-all-100 <?php if($info['ispart'] == 1): ?>checked<?php endif; ?> "><input value="1" class="custom-radio" <?php if($info['ispart'] == 1): ?>checked="checked"<?php endif; ?> name="ispart" id=""  type="radio"><i class="glyph-icon icon-circle"></i></span></div>
                                        <label for="">频道封面</label>
                                        <div class="radio"><span class=" ui-state-default btn radius-all-100 <?php if($info['ispart'] == 2): ?>checked<?php endif; ?> "><input value="2"  class="custom-radio" <?php if($info['ispart'] == 2): ?>checked="checked"<?php endif; ?> name="ispart" id="" type="radio"><i class="glyph-icon icon-circle"></i></span></div>
                              ...
                              <div class="form-row" id="dir_url" >
                                    ...
                                    <div class="form-input col-md-4">
                                        <input type="text" placeholder="如：Guestbook/index" value="<?php echo ($info["dir_url"]); ?>"  name="dir_url"/>
                                    </div>
                                </div>
        ...
        <div id="normal-tabs-2" aria-labelledby="ui-id-5" class="ui-tabs-panel ui-widget-content ui-corner-bottom" role="tabpanel" style="display: none;" aria-expanded="false" aria-hidden="true">
                <div class="form-row">
                      ...
                      <div class="form-input col-md-4">
                          <input type="text"  name="index_template" value="<?php echo ($info["index_template"]); ?>"/>
                      </div>
                  </div>
               <div class="form-row">
                      <div class="form-label col-md-1">
                      ...
                      <div class="form-input col-md-4">
                          <input type="text"  name="list_template" value="<?php echo ($info["list_template"]); ?>"/>
                      </div>
                  </div>
                <div class="form-row">
                      <div class="form-label col-md-1">
                      ...
                      <div class="form-input col-md-4">
                          <input type="text"  name="article_template" value="<?php echo ($info["article_template"]); ?>"/>
                      </div>
                  </div>
               <div class="form-row">
                      <div class="form-label col-md-1">
                      ...
                      <div class="form-input col-md-4">
                          <input type="text"  name="seo_title" value="<?php echo ($info["seo_title"]); ?>"/>
                      </div>
                  </div>
                <div class="form-row">
                      <div class="form-label col-md-1">
                      ...
                      <div class="form-input col-md-4">
                          <input type="text"  name="keyword"  value="<?php echo ($info["keyword"]); ?>"/>
                      </div>
                  </div>
               <div class="form-row">
                      <div class="form-label col-md-1">
    ...
    <script type="text/javascript">
       ...
       showErrors: function (errorMap, errorList) {
                ...
                var submitData = {
                        ...
                        ishidden:$("input[name='ishidden']:checked",$form).val(),
