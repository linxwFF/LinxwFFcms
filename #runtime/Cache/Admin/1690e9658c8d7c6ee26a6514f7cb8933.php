                ...
                <form method="post" class="col-md-4 center-margin form-vertical mrg25T"  id="loginForm" action="<?php echo U('Public/doLogin');?>">
                    <div class="ui-dialog  mrg25T" id="login-form" style="position: relative !important;">
                        ...
                        <div class="ui-dialog-buttonpane text-center">
                            ...
                            &nbsp;
                            <a href="/LinxwFFcms/index.php" target="_blank" style=" text-decoration:underline">不想登录？，去首页</a>
                        </div>
                    </div>
                </form>
            </div>
         ...
         <div class="footer">
            <div class="inner">
                <div class="copyright clearfix">
                    <p class="copyright_ch"><a target="_blank" href="<?php echo C('SITE_URL');?>">后台管理系统</a></p>
                    <p class="copyright_en"> &copy; <?php echo date("Y");?> , All Rights Reserved.</p>
                </div>
            </div>
        </div>
    </body>
